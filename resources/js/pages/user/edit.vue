<template>  
 <b-modal size="xl" id="edit-user" ref="edit-user" title="Setting Jabatan">
        ...
        <div class="form-group">
            ...
            <input   type="email" id="email" class="form-control" placeholder="email" v-model="user.email" disabled>        
        </div>  
        <div class="form-group">
        ...
        <div class="form-group">      
                ...
                <div class="form-check form-check-inline">
                  <label class="form-check-label">
                    <input class="form-check-input" type="radio" name="user" id="" :value="1" v-model="user.status"> Aktif
                  </label>
                </div>
                <div class="form-check form-check-inline">
                  <label class="form-check-label">
      ...
      export default {
          ...
          methods : {
             ...mapMutations('user_stores', ['CLEAR_FORM', 'SHOW_FOTO', 'SIMPAN_FOTO']),
                ...mapActions('user_stores', ['update_user', 'get_user']),            
              proses (ev) {
                  ev.preventDefault()
                  this.update_user().then(() => {
