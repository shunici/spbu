<template>  
 <b-modal id="edit-barang" ref="edit-barang" title="Edit">   
  ...
  <template #modal-footer>
        <div class="w-100">         
          ...
          >                 
            ...
            size="sm"
            class="float-left"
            @click="$bvModal.hide('edit-barang')"
          >
            Tutup
          </b-button>
        </div>
...
import formBarang from './form.vue'
      ...
      export default {
          ...
          methods : {
                ...
                ...mapActions('barang_stores', ['update_barang', 'get_barang']),            
              proses (ev) {
                  ev.preventDefault()
                  this.update_barang().then(() => {
                          this.pesan.sukses = true
                     setTimeout(function () {
                        this.get_barang();
                        //close modal                   
                        this.$bvModal.hide('edit-barang')
                        this.CLEAR_FORM();
