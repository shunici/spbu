<template>  
 <b-modal size="xl" id="edit-inventaris" ref="edit-inventaris" title="Edit"  :header-bg-variant="'info'">
  ...
  <template #modal-footer>
        <div class="w-100">         
          ...
          >                        
            ...
            size="sm"
            class="float-left"
            @click="$bvModal.hide('edit-inventaris')"
          >
            Tutup
          </b-button>
        </div>
...
import uangInput from '../../components/uang_input.vue';
      ...
      export default {
          ...
          methods : {
                ...
                ...mapActions('inventaris_stores', ['update_inventaris', 'get_inventaris']),            
              proses (ev) {
                  ev.preventDefault()
                  this.update_inventaris().then(() => {
                          this.pesan.sukses = true
                     setTimeout(function () {
                        this.get_inventaris();
                        //close modal                   
                        this.$bvModal.hide('edit-inventaris')
                        this.CLEAR_FORM();
